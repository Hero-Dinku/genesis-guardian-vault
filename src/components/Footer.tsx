  ...
  return (
    <footer className="py-8 bg-background border-t border-border">
      <div className="container mx-auto px-6">
        ...
        <div className="relative group animate-fade-in max-w-6xl mx-auto">
          ...
          <div className="relative rounded-lg overflow-hidden border-2 border-primary/20 shadow-xl h-[400px] hover:border-primary/40 transition-all duration-300 hover:scale-[1.01] hover:shadow-2xl">
