        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          ...
          <div className="relative group animate-fade-in">
            ...
            <div className="relative rounded-lg overflow-hidden border-2 border-primary/20 shadow-xl h-[250px] hover:border-primary/40 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl">
              <div className="absolute top-3 left-3 z-10 bg-background/90 backdrop-blur-sm px-3 py-1.5 rounded-full border border-primary/20 shadow-lg">
              ...
              <iframe
                ...
                loading="lazy"
                referrerPolicy="no-referrer-when-downgrade"
                title="Asmex AI Location - Footer"
